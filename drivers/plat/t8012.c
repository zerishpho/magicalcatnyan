...
{
    // T8012
    if(*(uint32_t*)PAYLOAD_BASE_ADDRESS_T8012 == 0)
    {
        //memcpy(relocate_addr, load_addr, size)
        memcpy((void*)PAYLOAD_BASE_ADDRESS_T8012, (void*)0x801000000, 0x80000);
        ...
        uint64_t* offsetBase = (uint64_t*)(PAYLOAD_BASE_ADDRESS_T8012 + 0x40);
